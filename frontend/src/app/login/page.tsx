      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-dark_spring_green-500 via-sea_green-400 to-dark_spring_green-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-5 text-white/90">
          <div className="flex items-start space-x-4 bg-white/10 backdrop-blur-sm p-4 rounded-2xl border border-white/20">
            ...
            <div>
              <h3 className="font-semibold text-white text-lg mb-1">Animal Care</h3>
              <p className="text-sm text-white/80">Monitor health, feeding, and habitat needs</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4 bg-white/10 backdrop-blur-sm p-4 rounded-2xl border border-white/20">
            ...
            <div>
              <h3 className="font-semibold text-white text-lg mb-1">Guest Services</h3>
              <p className="text-sm text-white/80">Handle ticketing and visitor experiences</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4 bg-white/10 backdrop-blur-sm p-4 rounded-2xl border border-white/20">
            ...
            <div>
              <h3 className="font-semibold text-white text-lg mb-1">Insights</h3>
              <p className="text-sm text-white/80">View analytics and generate reports</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center text-sm text-gray-600">
            <p>Zoo Database Management System</p>
