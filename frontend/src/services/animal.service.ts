...
export const animalService = {
  ...
  async delete(id: number, activeStatus?: 'transferred' | 'deceased', deletionNotes?: string): Promise<void> {
    await apiClient.delete(`/animals/${id}`, { data: { activeStatus, deletionNotes } });
  },
